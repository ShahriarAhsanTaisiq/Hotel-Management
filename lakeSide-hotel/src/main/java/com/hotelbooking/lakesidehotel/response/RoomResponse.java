package com.hotelbooking.lakesidehotel.response;
...
//    public RoomResponse(Long id, String roomType, BigDecimal roomPrice, boolean isBooked, byte[] photoBytes, List<BookingResponse> bookingResponseList) {
//        this.id = id;
//        this.roomType = roomType;
//        this.roomPrice = roomPrice;
